...
This is a tensorflow MNIST example modified from original tensorflow source.  It contains two python files, digitstrain.py trains a multilayer CNN using MNIST data and save the trained model to the model directory, while digitspredict.py reads the model and report the prediction accuray using the test data set. It can reach an respectable accuracy of about 99.2%. 
